...
const canvasRow = document.querySelector(".js-canvas-row");
...
`;
  ...
  const particleFragment = `
    void main() {
        ...
        float ll = length(xy);
        gl_FragColor = vec4(0.16, 0.36, 0.65, step(ll, 0.5));  
    }
    `;

  let globalCanvas = true;
  ...
  class Canvas {
    constructor() {
      this.config = {
        canvas: canvasRow.querySelector("canvas"),
        winWidth: canvasRow.offsetWidth,
        winHeight: canvasRow.offsetHeight,
        aspectRatio: canvasRow.offsetWidth / canvasRow.offsetHeight,
    ...
    render() {
      ...
      if (intersects.length) {
        this.particleMaterial.uniforms.uMouse.value.z = lerp(
          this.particleMaterial.uniforms.uMouse.value.x,
    ...
    onResize() {
      if (innerWidth > 575) {
        ...
        this.config.winWidth = canvasRow.offsetWidth;
        this.config.winHeight = canvasRow.offsetHeight;
        this.camera.aspect = canvasRow.offsetWidth / canvasRow.offsetHeight;
